return {
  ...
  keys = {
    ...
    { "<leader>fe", function() Snacks.explorer() end, 
    ...
    { "<leader>fr", function() Snacks.picker.recent() end, 
      desc = "Recent files" },
    { "<leader>fc", function() Snacks.picker.commands() end, 
      desc = "Commands" },
    ...
    { "<leader>bd", function() Snacks.bufdelete() end, 
      desc = "Delete Buffer" },
    { "<S-h>", function() vim.cmd("bprevious") end, 
      desc = "Prev buffer" },
    { "<S-l>", function() vim.cmd("bnext") end, 
      desc = "Next buffer" },
    { "[b", function() vim.cmd("bprevious") end, 
      desc = "Prev buffer" },
    { "]b", function() vim.cmd("bnext") end, 
      desc = "Next buffer" },
    ...
    { "<leader>gb", function() Snacks.picker.git_log_line() end, 
      desc = "Git Blame" },
    { "<leader>gc", function() Snacks.picker.git_log_file() end, 
      desc = "Git Commits" },
  ...
  init = function()
    ...
    vim.keymap.set("n", "<leader>bo", "<cmd>BufferCloseOthers<cr>", 
