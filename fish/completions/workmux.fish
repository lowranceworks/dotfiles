...
complete -c workmux -n "__fish_workmux_using_subcommand add" -l headless -d 'Create and provision the worktree without a multiplexer target'
complete -c workmux -n "__fish_workmux_using_subcommand add" -l json -d 'Emit a machine-readable headless provisioning receipt'
